...
namespace MagicFire.HuanHuoUFrame
{
    ...
    [PrefabMonoSingleton(
        "Assets/_MagicFire/ProjectsPrefabs/HuanHuoMVVM/AuxiliaryPrefabs/PlayerTarget.prefab",
        "Prefabs",
    ...
    public class PlayerTarget : MonoSingleton<PlayerTarget>
    {
        ...
        private void FixedUpdate()
        {
            ...
            transform.DOMove(AvatarStateController.Instance.transform.position, 0.8f);
        }
    }
