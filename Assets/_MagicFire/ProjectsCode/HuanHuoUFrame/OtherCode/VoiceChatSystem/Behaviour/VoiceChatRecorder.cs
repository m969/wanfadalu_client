...
namespace MagicFire.HuanHuoUFrame
{
    public class VoiceChatRecorder : MonoBehaviour
    {
        ...
        private void SendSample(VoiceChatPacket packet)
        {
            //KBEngine.Avatar.MainAvatar.SendVoiceSample(packet.Data, packet.Length, packet.PacketId);
            KBEngine.Event.fireIn("SendVoiceSample", packet.Data, packet.Length, packet.PacketId);
        }
