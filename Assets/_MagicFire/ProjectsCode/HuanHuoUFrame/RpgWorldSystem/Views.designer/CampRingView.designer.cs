...
namespace MagicFire.HuanHuoUFrame {
    ...
    public class CampRingViewBase : SuperPowerRingView {
        ...
        public override System.Type ViewModelType {
            get {
                return typeof(CampEntityViewModel);
            }
        }
        
        public CampEntityViewModel CampEntity {
            get {
                return (CampEntityViewModel)ViewModelObject;
            }
        }
        ...
        protected override void InitializeViewModel(uFrame.MVVM.ViewModels.ViewModel model) {
            ...
            var campringview = ((CampEntityViewModel)model);
            campringview.campName = this._campName;
        }
        ...
        public override void Bind() {
            ...
            if (_BindcampName) {
                this.BindProperty(this.CampEntity.campNameProperty, this.campNameChanged, _campNameOnlyWhenChanged);
            }
        }
